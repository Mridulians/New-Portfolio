...
const Navbar = () => {
  ...
  return (
    <>
      <div className="bg-zinc-900 hidden md:flex flex-row py-[2rem] px-[2rem] justify-between">
        <h2 className="font-bold text-[2rem] text-white">MRIDUL</h2>

        <div className="flex flex-row items-center gap-[2rem] lg:gap-[3rem]">
          <div className="list-none text-white flex gap-[20px] cursor-pointer">
      ...
      {sidebarVisible && (
        <div className={`sidebar_content ${sidebarVisible ? "show" : ""}`}>
          ...
          <div className="flex flex-row justify-center items-center w-[100%] gap-[2rem] py-[4rem] px-[0rem]">
            <img src={Insta} alt="" className="w-[30px] h-[30px]" />
